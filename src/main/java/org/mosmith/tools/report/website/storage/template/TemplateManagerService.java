...
import org.mosmith.tools.report.website.storage.datasource.DataSourceTemplateEntity;
import org.mosmith.tools.report.website.storage.utils.IDUtils;
...
public class TemplateManagerService {
    ...
    public List<Map<String, Object>> getTemplates(String groupId) {
        ...
        Query query=entityManager.createQuery("SELECT t.id AS id, t.groupId AS groupId, t.name AS name, t.group as isGroup, t.path as path FROM Template t WHERE t.groupId=:groupId");
    ...
    public Map<String, Object> getTemplate(String id) {
        ...
        templateInfo.put(PATH, template.getPath());
    ...
    public String createTemplate(Map<String, Object> templateInfo) {
        ...
        TemplateEntity templateGroup = entityManager.find(TemplateEntity.class, groupId);
        String groupPath="";
    ...
    public void renameTemplate(String id, String newName) {
        ...
        if(template.isGroup()) {
            String newPath=template.getPath();
            Query childQuery=entityManager.createQuery("SELECT t FROM Template t where t.path like '${path}/%'"
                    .replace("${path}", oldPath));
            List<TemplateEntity> children=childQuery.getResultList();
            for(TemplateEntity child: children) {
